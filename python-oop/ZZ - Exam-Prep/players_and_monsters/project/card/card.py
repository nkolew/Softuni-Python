...
class Card(ABC):
    ...
    def __init__(self, name: str) -> None:
        self.name = name
        self.damage_points = self._initial_damage_points
        self.health_points = self._initial_health_points
    ...
    @property
    @abstractmethod
    def _initial_damage_points(self) -> int:
        ...

    @property
    @abstractmethod
    def _initial_health_points(self) -> int:
        ...
